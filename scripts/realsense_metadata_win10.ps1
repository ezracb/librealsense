...
$MultiPinDevices =
    "USB\VID_8086&PID_0B07&MI_00",# RS430+RGB(AWGC)
    "USB\VID_8086&PID_0B01&MI_00",# RS430+RGB+MM(AWGCT)
    "USB\VID_8086&PID_0AD5&MI_00",# RS430+MM(AWGT)
    "USB\VID_8086&PID_0AD4&MI_00",# RS430(AWG)
    "USB\VID_8086&PID_0AFE&MI_00",# RS420+MM(PWGT)
    "USB\VID_8086&PID_0AFF&MI_00",# RS410+MM(ASRT)
    "USB\VID_8086&PID_0AD3&MI_00",# RS410+RGB(ASRC)
    "USB\VID_8086&PID_0AD2&MI_00",# RS410(ASR)
